    ...
    <section id="projects" className="section-padding">
      <div className="container-max">
        ...
        <div ref={headingRef} className="mb-14">
          ...
          <h2 className="text-4xl font-bold text-white mt-2">Selected Projects</h2>
          <p className="text-slate-500 mt-3 max-w-lg pb-2">
            A few things I've built — click any card for the full breakdown.
          </p>
        </div>
