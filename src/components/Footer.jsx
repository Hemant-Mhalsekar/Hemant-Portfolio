...
const Footer = () => {
  return (
    <footer className="border-t border-[#1e2638] bg-[#0a0d13] py-12 px-6">
      <div className="container-max flex flex-col items-center justify-center gap-6">
        ...
        <div className="text-center">
          ...
          <p className="text-slate-400 text-sm mt-1">Building ideas into products.</p>
        </div>
